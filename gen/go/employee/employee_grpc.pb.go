...
const (
	...
	Employee_ChangeEmployee_FullMethodName = "/employee.Employee/ChangeEmployee"
)
...
type EmployeeClient interface {
	...
	ChangeEmployee(ctx context.Context, in *ChangeEmployeeRequest, opts ...grpc.CallOption) (*ChangeEmployeeResponse, error)
}
...
func (c *employeeClient) ChangeEmployee(ctx context.Context, in *ChangeEmployeeRequest, opts ...grpc.CallOption) (*ChangeEmployeeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ChangeEmployeeResponse)
	err := c.cc.Invoke(ctx, Employee_ChangeEmployee_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EmployeeServer interface {
	...
	ChangeEmployee(context.Context, *ChangeEmployeeRequest) (*ChangeEmployeeResponse, error)
...
func (UnimplementedEmployeeServer) ChangeEmployee(context.Context, *ChangeEmployeeRequest) (*ChangeEmployeeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ChangeEmployee not implemented")
}
...
func _Employee_ChangeEmployee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChangeEmployeeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EmployeeServer).ChangeEmployee(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Employee_ChangeEmployee_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmployeeServer).ChangeEmployee(ctx, req.(*ChangeEmployeeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Employee_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ChangeEmployee",
			Handler:    _Employee_ChangeEmployee_Handler,
		},
	},
